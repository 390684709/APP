...
- (void)application:(UIApplication *)application didReceiveLocalNotification:(UILocalNotification *)notification {
    ...
    UIAlertView* view = [[UIAlertView alloc] initWithTitle: NSLocalizedString(@"Smart Watch", @"Smart Watch") message:str delegate:self cancelButtonTitle: NSLocalizedString(@"Cancel", @"Cancel") otherButtonTitles:notification.alertAction, nil];
    [view show];
}
...
-(void)showDialog:(NSString*)deviceName
{
    ...
    alertDialog = [[UIAlertView alloc] initWithTitle: NSLocalizedString(@"Smart Watch Alert", @"Smart Watch Alert") message:str delegate:self cancelButtonTitle:NSLocalizedString(@"Dismiss", @"Dismiss") otherButtonTitles:nil];
    [alertDialog show];
}
