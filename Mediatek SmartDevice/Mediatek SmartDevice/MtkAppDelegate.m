...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName: kFinishLaunchNotification object: nil];
    return YES;
}
...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
    ...
    NSLog(@"[applicationWillEnterForeground] enter， current Version 1.1.7");
