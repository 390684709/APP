...
@property int mRangeValue;                                                  //indicate device when should alert (inRnage, outOfRange)
@property int mRangeType;                                                   //indicate device range size to alert (Near, Middle, Far)
