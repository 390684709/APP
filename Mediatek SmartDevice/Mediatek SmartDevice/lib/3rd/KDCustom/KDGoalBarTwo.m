...
@implementation KDGoalBarTwo
@synthesize    percentLabel;
@synthesize    targetLabel;
@synthesize    calLabel;
@synthesize   journeyImg;
...
//    CGRect labeliFrame = journeyImg.frame;
//    labeliFrame.origin.x = frame.size.width / 2 - targetLabel.frame.size.width / 2;
//    labeliFrame.origin.y = frame.size.width / 2 - targetLabel.frame.size.height / 1.2;
//    journeyImg.frame = labeliFrame;
...
-(void)setup {
    ...
    journeyImg = [[UIImageView alloc] initWithFrame:CGRectMake(55, 32, 26, 25)];
    NSString * path = [[NSBundle mainBundle]pathForResource:@"icon_09" ofType:@"png"];
    UIImage *image = [UIImage imageWithContentsOfFile:path];
//    journeyImg.layer.masksToBounds = YES;
    [journeyImg setImage:image];
//    journeyImg = [[UIImageView alloc] initWithImage:[UIImage imageWithContentsOfFile:@"icon_09.png"]];
...
//    [calLabel setTextColor:[UIColor lightGrayColor]];
    ...
    percentLayer = [KDGoalBarPercentLayerTwo layer];
