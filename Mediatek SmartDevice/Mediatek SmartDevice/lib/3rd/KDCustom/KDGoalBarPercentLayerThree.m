...
@implementation KDGoalBarPercentLayerThree
@synthesize percent;
@synthesize bleData;
...
-(void)DrawRight:(CGContextRef)ctx {
    ...
    CGContextSetFillColorWithColor(ctx, [UIColor colorWithRed:129/255.0 green:198/255.0 blue:40/255.0 alpha:1].CGColor);
