...
- (void)addRecord: (NSArray*)record {
    ...
    for(uint i=0; i<record.count; i++){
        ...
        col1.font = [UIFont fontWithName:@"Helvetica" size:10.0];
        col1.frame = rect;
        ...
        {
            col1.textColor = [UIColor colorWithRed:216/255.0 green:8/255.0 blue:0/255.0 alpha:1.0f];
        }
        ...
        CGFloat h = col1.frame.size.height + 5;
        if(h > rowHeight){
            rowHeight = h;
        }
